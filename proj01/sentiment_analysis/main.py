...
T = 25
L = 0.01
train_pegasos = p1.pegasos(train_bow_features, train_labels, T, L)
pred = p1.classify(test_bow_features, train_pegasos[0], train_pegasos[1])
accuracy = p1.accuracy(pred, test_labels)
